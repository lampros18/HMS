...
<title>Διαχειριστής - Καταχώρηση διοικητικού υπαλλήλου</title>
...
<div>
	<!-- Υποστήριξη logout -->
			<form:form action="${pageContext.request.contextPath}/logout" style="float:left; padding-right:0.3%;"
				method="POST">
			...
			τους και μας γυρνάει στην αρχική σελίδα του διαχειριστή --> <!-- Αξιοθρήνητη προσπάθεια για αισθητική -->
			<form:form action="${pageContext.request.contextPath}/" style="float:left float:left; padding-right:0.3%;"
				method="GET">
